        ...
        {navLinks.map(({ href, label }) => (
          <li key={href} className="h-full">
            <Link
              href={href}
              className={clsx(
                "flex sm:inline-flex h-full flex-col text-start sm:items-center justify-center px-2 sm:px-3 py-2 sm:py-0 border-b-2 no-underline font-medium text-xl transition-all duration-300 hover:text-indigo-600",
